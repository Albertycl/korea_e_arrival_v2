      ...
      <div className="w-full max-w-5xl mx-auto font-sans animate-pop-in bg-white shadow-xl p-8 border border-gray-200 text-gray-800">
        <div className="text-center mb-10">
          <div className="flex items-center justify-center gap-2 mb-4">
             ...
             <h2 className="text-3xl font-black text-gray-900 tracking-tight">电子入境申报单提交完毕</h2>
          </div>
          
          <div className="bg-[#f2f7ff] p-6 rounded border border-[#e1ecff] inline-block text-left w-full max-w-4xl">
             <p className="text-lg font-bold mb-2">这是 <span className="text-[#0047A0] underline">{data.familyName} {data.givenName}</span> 先生/女士电子入境申报单提交现况。</p>
             ...
             <div className="flex border-b border-gray-200">
                ...
                <div className="flex-1">
                   <div className="flex border-b border-gray-100">
                      <div className="w-24 p-3 font-bold text-gray-500 border-r border-gray-100">预计滞留地</div>
                      <div className="flex-1 p-3">
                         <div className="flex gap-2 items-center mb-1">
                            <span className="text-[10px] bg-[#0047A0] text-white px-1.5 py-0.5 rounded font-bold">KOR</span>
                            <span>{data.koreaAddressKr}</span>
                         </div>
                         <div className="flex gap-2 items-center">
                            <span className="text-[10px] bg-gray-500 text-white px-1.5 py-0.5 rounded font-bold">ENG</span>
                            <span>{data.koreaAddress}, {data.detailAddress}</span>
                         </div>
                      </div>
                   </div>
                   <div className="flex">
                      <div className="w-24 p-3 font-bold text-gray-500 border-r border-gray-100">联系电话</div>
        ...
        <div className="flex justify-between items-center mt-12 px-2">
           <button onClick={() => setStep(3)} className="px-8 py-2.5 bg-[#dcdcdc] text-gray-700 font-bold rounded text-sm hover:bg-gray-300 transition-colors">取消</button>
           <div className="flex gap-2">
              <button onClick={() => setStep(3)} className="px-8 py-2.5 border border-[#0047A0] text-[#0047A0] font-bold rounded text-sm hover:bg-blue-50 transition-colors">修改</button>
              <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="px-10 py-2.5 bg-[#2c75e9] text-white font-bold rounded text-sm hover:bg-blue-700 shadow-md transition-all">查看电子入境申报单</button>
           </div>
        </div>
  ...
  return (
    <div className="w-full max-w-6xl mx-auto font-sans animate-slide-in-right bg-white p-6 shadow-sm border border-gray-200">
        ...
        <div className="border-t-[1px] border-blue-500 border-b border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
             <div className="flex items-center border-b md:border-b-0 md:border-r border-gray-200">
                <div className="w-32 bg-gray-50 p-3 text-xs font-bold text-gray-600 border-r border-gray-200 h-full flex items-center">
        ...
        <div className="border-t border-blue-500">
              ...
              <div className="flex-1 text-xs">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 border-b border-gray-100">
                    <div className="flex items-center p-3 md:border-r border-gray-100">
                       <span className="w-24 font-medium text-gray-600"><span className="text-red-500">*</span> 預計入境日</span>
                    ...
                    <div className="flex items-center p-3">
                       <span className="w-24 font-medium text-gray-600"><span className="text-red-500">*</span> 航班名稱</span>
                 ...
                 <div className="flex items-center p-3">
                    <span className="w-24 font-medium text-gray-600">前一出發地</span>
                    <div className="flex gap-2 flex-1 items-center">
                       <select className="border border-gray-300 rounded px-2 py-1.5 text-xs bg-white flex-1"><option>TAIWAN</option></select>
                       <select className="border border-gray-300 rounded px-2 py-1.5 text-xs bg-white flex-1"><option>TAIPEI (TPE)</option></select>
                       <span className="text-gray-400">→</span>
                       <span className="bg-gray-100 px-4 py-1.5 rounded text-gray-500 flex-1">韓國</span>
                    </div>
                 </div>
              </div>
           </div>
           ...
           <div className="flex flex-col md:flex-row border-b border-gray-200">
              ...
              <div className="flex-1 text-xs">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 border-b border-gray-100">
                    <div className="flex items-center p-3 md:border-r border-gray-100">
                       <span className="w-24 font-medium text-gray-600"><span className="text-red-500">*</span> 預計出境日</span>
                       <div className="flex-1 flex border border-gray-300 rounded items-center bg-white px-2 py-1.5">
                    ...
                    <div className="flex items-center p-3">
                       <span className="w-24 font-medium text-gray-600">航班名稱</span>
                       <div className="flex gap-2 flex-1">
                          <select className="border border-gray-300 rounded px-2 py-1 text-xs bg-white w-28"><option>航空公司</option></select>
                 ...
                 <div className="flex items-center p-3">
                    <span className="w-24 font-medium text-gray-600">下一目的地</span>
                    <div className="flex gap-2 flex-1 items-center">
                       <span className="bg-gray-100 px-4 py-1.5 rounded text-gray-500 flex-1">韓國</span>
                       <span className="text-gray-400">→</span>
                       <select className="border border-gray-300 rounded px-2 py-1.5 text-xs bg-white flex-1 font-bold text-blue-700"><option>台灣 TAIWAN</option></select>
                       <select className="border border-gray-300 rounded px-2 py-1.5 text-xs bg-white flex-1 font-bold text-blue-700"><option>桃園機場 TAOYUAN (TPE)</option></select>
                    </div>
                 </div>
              </div>
           </div>
           ...
           <div className="flex flex-col md:flex-row border-b border-gray-200">
              ...
              <div className="flex-1 p-4 text-xs space-y-4">
                 <div className="flex items-center gap-2">
                    <span className="w-24 font-medium text-gray-600">查詢簽證信息</span>
                    <input type="text" placeholder="請輸入簽證號。" className="border border-gray-300 rounded px-3 py-1.5 text-xs flex-1" />
                    <button className="bg-gray-700 text-white px-4 py-1.5 rounded text-xs font-bold">查詢</button>
                    <span className="text-gray-400">ℹ️ 獲取簽證信息中的滯留地、聯繫方式信息。</span>
                 </div>
                 <div className="space-y-2">
                    ...
                    <div className="space-y-1 pl-6">
                       <div className="flex items-center"><span className="bg-[#0047A0] text-white text-[10px] font-bold px-2 py-2 rounded-l w-12 text-center">KOR</span><input type="text" value={data.koreaAddressKr} readOnly className="border border-gray-300 rounded-r px-3 py-2 text-xs w-full bg-gray-50" /></div>
                       <div className="flex items-center"><span className="bg-[#666] text-white text-[10px] font-bold px-2 py-2 rounded-l w-12 text-center">ENG</span><input type="text" value={data.koreaAddress} readOnly className="border border-gray-300 rounded-r px-3 py-2 text-xs w-full bg-gray-50" /></div>
                 ...
                 <div className="flex items-center gap-2">
                    <span className="w-24 font-bold text-gray-700"><span className="text-red-500">*</span> 聯繫電話</span>
      ...
      <div className="flex justify-center gap-4 py-8">
         <button onClick={handlePrev} className="px-8 py-2.5 border border-gray-300 bg-white text-gray-600 rounded text-sm font-bold shadow-sm hover:bg-gray-50">取消 (Prev)</button>
         <button onClick={handleNext} className="px-12 py-2.5 bg-korea-blue text-white rounded text-sm font-bold shadow-md hover:bg-blue-800">下一步 (Next)</button>
      </div>
    </div>
  );
};
